...
/**
 * A copied migration under `migrations/` and its source under
 * `migrations/auth/`, or null when either file does not exist.
 */
...
test("a file already applied from another directory does not re-apply", () => {
  // Keyed on basename: a database that already ran the file must not run it
  // again even if the same name appears under another directory.
